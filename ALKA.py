...
class ALKA(nn.Module):
    def __init__(self, num_classes, pretrained_embedding, fusion_dim=256, dropout=0.5, filter_sizes=None, *args, **kwargs):
        ...
        self.text_cnn = AlkaTextCNN(pretrained_embedding=pretrained_embedding, filter_sizes=filter_sizes)
